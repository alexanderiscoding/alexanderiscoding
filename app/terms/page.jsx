...
export default function Page() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6 text-foreground text-gray-800 dark:text-white">Termos de uso</h1>

      <p className="mb-6 text-gray-800 dark:text-white">Ao usar nossos serviços, você concorda com estes termos - Por favor, leia-os com atenção.</p>
