  ...
  return (
    <>
      ...
      <div className="space-y-4">
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-4">Como podemos alterar os Termos de Serviço:</h2>
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-4">Podemos fazer alterações, suspender ou retirar o Serviço:</h2>
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-4">Cadastro nos Serviços:</h2>

        <p>
          Para utilizar os Serviços deve primeiro registar-se e criar uma conta de usuário.
        </p>

        <p>Para se cadastrar como usuário:</p>
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>Você manterá seus detalhes de conta/login confidenciais e seguros, incluindo seus dados de usuário, tokens e qualquer outra informação que faça parte de nossos procedimentos de segurança, e você não os divulgará a mais ninguém. Você entrará em contato com dados@alexanderiscoding.com imediatamente se acreditar que alguém usou ou está usando sua conta sem sua permissão ou se sua conta estiver sujeita a qualquer outra violação de segurança. Você também concorda em ter um cuidado especial ao acessar sua conta de um computador público ou compartilhado para que outras pessoas não possam acessar, visualizar ou registrar seus tokens ou outras informações pessoais.</li>
          <li>Você cumprirá integralmente estes Termos de Uso para todos os Usuários e todas as outras partes que se aplicam ao seu uso dos Serviços.</li>
        </ul>

        <h2 className="text-2xl font-semibold mt-6 mb-4">Direitos que temos, incluindo suspender ou encerrar sua conta:</h2>

        <ul className="list-disc pl-6 space-y-2">
          <li>Podemos, mas não somos obrigados a moderar ou revisar qualquer conteúdo seu para verificar a conformidade com os Termos de Uso e/ou qualquer lei aplicável.</li>
          <li>É nossa política suspender o acesso a qualquer Conteúdo que você postar em nossos Serviços se tomarmos conhecimento de que ele não cumpre os Termos de Uso e/ou qualquer lei aplicável enquanto investigamos a suspeita de não conformidade ou ilegalidade de tal Conteúdo. Se suspendermos o acesso a qualquer conteúdo seu, você poderá solicitar uma revisão de nossa decisão de suspender o acesso ao conteúdo relevante entrando em contato conosco em dados@alexanderiscoding.com. Após nossa investigação da suspeita de não conformidade ou ilegalidade do Conteúdo relevante, podemos tomar qualquer ação que consideremos apropriada, incluindo restabelecer o acesso ao Conteúdo ou remover ou desativar permanentemente o acesso ao Conteúdo relevante sem precisar obter qualquer consentimento de você e sem aviso prévio. Você concorda que, a seu próprio custo, nos fornecerá prontamente toda a assistência razoável (inclusive fornecendo cópias de qualquer informação que solicitarmos) em nossa investigação. Não seremos responsáveis ​​por qualquer perda sofrida por você decorrente da suspensão do acesso ao seu Conteúdo ou quaisquer outras medidas que tomarmos de boa fé para investigar qualquer suspeita de não conformidade ou ilegalidade de seu Conteúdo sob esta seção.</li>
          <li>Se suspendermos o acesso ou excluirmos qualquer um de seus Conteúdos, poderemos notificá-lo por e-mail, mas não somos obrigados a notificá-lo previamente sobre tal remoção ou suspensão.</li>
          <li>Reservamo-nos o direito, a nosso exclusivo critério, de rescindir seu acesso aos Serviços por qualquer motivo, avisando com 30 dias de antecedência por e-mail.</li>
          <li>Após o encerramento de sua conta, podemos lidar com seu Conteúdo de qualquer maneira apropriada de acordo com nossa Política de Privacidade (inclusive excluindo-a) e você não terá mais o direito de acessar seu Conteúdo. Não há nenhum recurso técnico para que você possa acessar seu Conteúdo após o encerramento de sua conta.</li>
          <li>Podemos investigar qualquer uso suspeito ou alegado de uso indevido, abuso ou uso ilegal dos Serviços e cooperar com as agências de aplicação da lei em tal investigação.</li>
          <li>Podemos divulgar quaisquer informações ou registros em nossa posse ou controle sobre seu uso dos nossos Serviços para agências de aplicação da lei em conexão com qualquer investigação de aplicação da lei de qualquer atividade ilegal, para proteger nossos direitos ou interesses legais, ou em resposta a um processo legal.</li>
        </ul>

        <h2 className="text-2xl font-semibold mt-6 mb-4">Pelo que não somos responsáveis:</h2>
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>Você concorda que não tem obrigação de seguir quaisquer sugestões, comentários, críticas ou instruções recebidas de outro Usuário e que, se optar por fazê-lo, o fará inteiramente por sua conta e risco.</li>
          <li>Os materiais que disponibilizamos nos Serviços são apenas para informação geral. Não fazemos promessas ou garantias sobre a precisão ou não de tais materiais, ou de que os Usuários alcançarão qualquer resultado específico com o uso de tais materiais.</li>
          <li>Não prometemos que os Serviços sejam compatível com todos os dispositivos e sistemas operacionais. Você é responsável por configurar sua tecnologia da informação, dispositivo e programas de computador para acessar.</li>
          ...
          <li>Enquanto tentamos garantir que os Serviços sejam seguro e livre de bugs e vírus, não podemos prometer que será e não temos controle sobre o Conteúdo fornecido pelos Usuários.</li>
